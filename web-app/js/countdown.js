/**
 * Created by c161635 on 2/17/14.
 */

//change the text below to reflect your own,
var before = "kickoff against BYU!!!"
...
function countdown(yr, m, d) {
    ...
    if (difference == 0)
        ...
        countdownValue = "Only " + difference + " days until " + before

    document.write(countdownValue)
}

function displayDeepThought() {
    var thoughtsArray = [
        ...
        "If a kid asks where rain comes from, I think a cute thing to tell him is 'God is crying.' And if he asks why God is crying, another cute thing to tell him is it's probably because of something you did.",
    ...
    var idx = Math.floor(Math.random()*thoughtsArray.length)

    document.write(thoughtsArray[idx]);
}