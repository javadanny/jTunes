	...
	<body>
		...
		<div id="show-genre" class="content scaffold-show" role="main">
			...
			<ol class="property-list genre">
				...
				<g:if test="${genreInstance?.description}">
				<li class="fieldcontain">
					<span id="description-label" class="property-label"><g:message code="genre.description.label" default="Description" /></span>
					
						<span class="property-value" aria-labelledby="description-label"><g:fieldValue bean="${genreInstance}" field="description"/></span>
