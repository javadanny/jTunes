...
<g:set var="entityName"
	value="${message(code: 'genre.label', default: 'Genre')}" />
...
<body>
	...
	<div class="container">
				...
				<thead>
					<tr>
						<g:sortableColumn property="name"
							title="${message(code: 'genre.name.label', default: 'Name')}" />
						<g:sortableColumn property="description"
							title="${message(code: 'genre.description.label', default: 'Description')}" />
					</tr>
				</thead>
				<tbody>
					<g:each in="${genreInstanceList}" status="i" var="genreInstance">
						<tr>
							<td>
								${fieldValue(bean: genreInstance, field: "name")}
							</td>
							<td><g:link action="show" id="${genreInstance.id}">
									${fieldValue(bean: genreInstance, field: "description")}
								</g:link></td>
						</tr>
					</g:each>
				</tbody>
		...
		<footer>
			<p>
				&copy; Carroll Solutions 2014&nbsp; <a href="/jTunes/system">System
					Specs</a>
			</p>
